...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7748397141:AAENwHS2muHUcWaFClamXMrqvyLOik6JMvU")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002548218950"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5528472143"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "Its_Robin_Bot")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002484371129"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002354031174"))
...
SHORT_API = os.environ.get("SHORTNER_API", "42975335ea3d5bd1675f5adc121deec5fe49b43b")

BOT_STATS_TEXT = "<b>BOT UPTIME</b>\n{uptime}"
USER_REPLY_TEXT = "Pʟᴇᴀꜱᴇ ᴅᴏɴ'ᴛ ᴍᴇꜱꜱᴀɢᴇ ᴍᴇ ᴅɪʀᴇᴄᴛʟʏ ɪ ᴀᴍ ᴏɴʟʏ ᴡᴏʀᴋ ꜰᴏʀ - @akd_bhai"
